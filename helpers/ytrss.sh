...
# 2021-07-27 automatically add rss url to clipboard w xclip +
#		add found yt channel feed to RSSPATH file (newsboat for me,
#		change accordingly)
...
NAME="$0:t:r"
COUNT='0'
RSSPATH="$XDG_CONFIG_HOME/newsboat/urls"
